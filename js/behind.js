...
var add = document.getElementsByClassName("add")[0];
var userEmailad = document.getElementById("userEmailad");
    ...
    success: function (result) {
      ...
      for (var i = 0; i < result.data.length; i++) {
        nameInfoF.innerHTML +=
          ...
          "</li>" +
          "<li>" +
          "<button class='revisef' >修改</button>" +
          "<button class='deletesf'>删除</button>" +
          "</li>" +
          "<li class='hid'>" +
          JSON.stringify(result.data[i]) +
          "</li>" +
